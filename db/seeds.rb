...
countries = Country.create([
    ...
    {name: "Canada", reason: "To support its allies in the War on Terror", assets: "Air Power", flag_link: "https://flagspot.net/images/a/au.gif"},
    ...
    {name: "Syrian Arab Republic", reason: "To preserve the dictatorship of President Bashar Al-Assad.", assets: "Air Power, Ground Forces, Chemical Weapons (WMD).", flag_link: "NEED FLAG LINK"}
    ])
...
strikes = Strike.create([
    {country_id: 2, target_id: 58, airstrike: true, date: "November 15, 2015", time: "22:00", area: "Raqqa"}
    ])
