...
countries = Country.create([
    ...
    {name: "Canada", reason: "To support its allies in the War on Terror", assets: "Air Power", flag_link: "https://flagspot.net/images/c/ca.gif"},
    ...
    {name: "Qatar", reason: "To counter Iranian regional expansion. To support its allies in the War on Terror.", assets: "Air Power. Monetary and Arms support to miliant groups.", flag_link: "https://flagspot.net/images/q/qa.gif"},
    {name: "Saudi Arabia", reason: "To counter Iranian regional influence. To support its allies in the War on Terror", assets: "Air Power. Monetary and Arms support to miliant groups.", flag_link: "https://flagspot.net/images/s/sa.gif"},
    {name: "Turkey", reason: "To destroy ISIL. To secure its borders, to stop the violence happening across its border, and to stem the flow of refugees. Also, to weaken and redirect Kurd militants.", assets: "Air Power. Artillary. Monetary and Arms support to miliant groups.", flag_link: "https://flagspot.net/images/t/tr.gif"},
    {name: "United Arab Emirates", reason: "To counter Iranian regional influence. To support its allies in the War on Terror.", assets: "Air Power. Monetary and Arms support to miliant groups.", flag_link: "https://flagspot.net/images/a/ae.gif"},
    {name: "United Kingdom", reason: "To defeat ISIL and end the recruitment and radicalization of UK citizens.", assets: "Air Power, Sea Power, ISR. Possibly Speical Forces and monetary/arms support to miliant groups.", flag_link: "https://flagspot.net/images/g/gb.gif"},
    {name: "Russia", reason: "To support the regime of Bashar Al-Assad. To counter Western and Arab support of anti-Assad militant groups. To support Iraninan regional influence.", assets: "Air Power, Sea Power, Land Forces, Monetary and Arms support to the Assad regime.", flag_link: "https://flagspot.net/images/r/ru.gif"},
    {name: "Iran", reason: "To support the regime of Bashar Al-Assad. To increase its regional influence. To counter Arab regional influence.", assets: "Ground forces, Monetary and Arms support to militant groups, military advisors/leadership.", flag_link: "https://flagspot.net/images/i/ir.gif"},
    {name: "Syrian Arab Republic", reason: "To preserve the dictatorship of President Bashar Al-Assad.", assets: "Air Power, Ground Forces, Chemical Weapons (WMD).", flag_link: "https://flagspot.net/images/s/sy.gif"},
    {name: "Israel", reason: "To eliminate sophisticated weaponry and heavy artilliary (SAM and SSM systems) being delivered to Israel's mortal enemy, Hezbollah, by the Iranian, Russian, Syrian, and (allegedly) North Korean militaries.", assets: "Air Power, ISR. Possible sea power, artilliary and special forces.", flag_link: "https://flagspot.net/images/i/il.gif"}
    ])
